...
document.querySelector(".scrolly").addEventListener("scroll", function () {
    console.log("Hello you just scrolled!")
})
...
document.querySelector(".green-text").addEventListener('mouseout', function(){
    document.querySelector(".green-text").style["color"] = "black"
})
...
document.querySelector(".green-text").addEventListener('mouseover', greenMachine)

function greenMachine () {
    document.querySelector(".green-text").style["color"] = "green"
}
